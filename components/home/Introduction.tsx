    ...
    <>
      <section id="introduction" className="relative">
        ...
        <div className="flex flex-col md:flex-row justify-between mt-12">
          <div className="text-center items-center md:text-start  order-2 md:order-none">
            {/* Name */}
          ...
          <div className="flex justify-center items-center md:items-start text-center aspect-square w-[260px] h-[400px] md:w-[380px] md:h-[560px] order-1 md:order-none mx-auto">
            <Image
              src={Profile}
              alt=""
              placeholder="blur"
              className="md:rotate-3 rounded-lg drop-shadow-2xl transition-all duration-200 md:hover:rotate-0"
            />
          </div>
        </div>
        <Background />
